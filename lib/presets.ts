...
export const PRESET_CHALLENGES: PresetChallenge[] = [
  {
    ...
    tasks: [
      {
        title: 'Identify 3 Recurring Charges or Rate Creep',
        description: 'Scan your transaction history and flag 3 services with recurring charges (annual increases >5%) or rate creep. Freely select from your history.',
        points: 20,
        is_mandatory: true,
      ...
      {
        title: 'Research Competitor Market Rates',
        description: 'Find current competitor pricing for 3+ of your flagged services. Upload screenshots with URLs showing alternative rates.',
        points: 20,
        is_mandatory: true,
        task_type: 'reading',
        verification_type: 'photo',
      ...
      {
        title: 'Call to Negotiate or Cancel',
        description: 'Contact one of the providers to negotiate a lower rate or cancel the service. Upload a screenshot of the call log showing the date and provider.',
        points: 25,
        is_mandatory: true,
      ...
      {
        title: 'Confirm Action Completed',
        description: 'Upload a screenshot showing the cancellation confirmation, refund approval, or new lower rate documentation.',
        points: 20,
        is_mandatory: true,
        task_type: 'custom',
        verification_type: 'photo',
      ...
      {
        title: 'Create Social Media Share Graphic',
        description: 'Generate a summary graphic showing which services you negotiated (titles, original vs. new rates). Share a screenshot of the graphic.',
        points: 15,
        is_mandatory: true,
        task_type: 'custom',
        verification_type: 'photo',
      ...
      {
        title: 'Negotiate a Second Service',
        description: 'Call a different provider and secure a rate reduction or cancellation. Upload proof of the negotiation result.',
        points: 25,
        is_mandatory: false,
        task_type: 'negotiation',
        verification_type: 'photo',
      ...
      {
        title: 'Negotiate a Third Service',
        description: 'Call another provider and document your negotiation outcome.',
        points: 25,
        is_mandatory: false,
        task_type: 'negotiation',
        verification_type: 'photo',
      ...
      {
        title: 'Confirm 3+ Rate Reductions',
        description: 'Secure confirmed rate reductions (or cancellations with savings) across 3+ services. Upload all confirmation emails or screenshots.',
        points: 25,
        is_mandatory: false,
        task_type: 'custom',
        verification_type: 'photo',
      ...
      {
        title: 'Switch Provider for Better Rate',
        description: 'Complete a service transfer to a cheaper provider and upload proof of the switch (confirmation email or new account screenshot).',
        points: 25,
        is_mandatory: false,
        task_type: 'subscription',
        verification_type: 'photo',
      ...
      {
        title: 'Automate Savings from Negotiation',
        description: 'Set up automatic transfer of the monthly savings into a dedicated savings account. Upload screenshot of the recurring transfer setup.',
        points: 25,
        is_mandatory: false,
        task_type: 'savings',
        verification_type: 'photo',
